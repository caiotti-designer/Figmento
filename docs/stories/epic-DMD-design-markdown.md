...
| DMD-2 | `import_design_system_from_md` MCP Tool (+ auto-preview hook) | @dev | @qa | DMD-1 | [ ] Draft |
| DMD-3 | `validate_design_md` MCP Tool | @dev | @qa | DMD-1 | [ ] Draft |
| DMD-4 | `export_design_system_to_md` MCP Tool | @dev | @qa | DMD-1 | [ ] Draft |
